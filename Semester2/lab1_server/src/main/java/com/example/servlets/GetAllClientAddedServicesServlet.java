...
@WebServlet(name = "getAllClientAddedServicesServlet", value = "/get-all-client-added-services")
public class GetAllClientAddedServicesServlet extends DBServlet {
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            var res = dbManager.GetAllClientAddedServices(clientId);
            String json = new Gson().toJson(res);
            out.println(json);
            logger.info("GET ALL CLIENT ADDED SERVICES, ID: "+ clientId);
